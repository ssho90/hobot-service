...
export KR_TOP50_EARNINGS_WATCH_INTERVAL_MINUTES="${KR_TOP50_EARNINGS_WATCH_INTERVAL_MINUTES:-5}"
export TIER1_EVENT_SYNC_INCLUDE_KR_IR_NEWS="${TIER1_EVENT_SYNC_INCLUDE_KR_IR_NEWS:-1}"
export KR_TIER1_IR_FEED_URLS="${KR_TIER1_IR_FEED_URLS:-https://www.hankyung.com/feed/finance,https://rss.etnews.com/Section902.xml}"
export GRAPH_RAG_ROUTER_LLM_TIMEOUT_SEC="${GRAPH_RAG_ROUTER_LLM_TIMEOUT_SEC:-10}"
export GRAPH_RAG_RECENT_DOC_PRIORITY_COUNT="${GRAPH_RAG_RECENT_DOC_PRIORITY_COUNT:-8}"
export GRAPH_RAG_RECENT_CITATION_TARGET_COUNT="${GRAPH_RAG_RECENT_CITATION_TARGET_COUNT:-1}"
export GRAPH_RAG_RECENT_CITATION_MAX_AGE_HOURS="${GRAPH_RAG_RECENT_CITATION_MAX_AGE_HOURS:-168}"
export GRAPH_RAG_DATA_FRESHNESS_WARN_HOURS="${GRAPH_RAG_DATA_FRESHNESS_WARN_HOURS:-72}"
export GRAPH_RAG_DATA_FRESHNESS_FAIL_HOURS="${GRAPH_RAG_DATA_FRESHNESS_FAIL_HOURS:-168}"
export GRAPH_RAG_PHASE5_ALERT_ENABLED="${GRAPH_RAG_PHASE5_ALERT_ENABLED:-1}"
export GRAPH_RAG_PHASE5_ALERT_ONLY_ON_WARNING="${GRAPH_RAG_PHASE5_ALERT_ONLY_ON_WARNING:-1}"
export GRAPH_RAG_PHASE5_ALERT_CHANNEL="${GRAPH_RAG_PHASE5_ALERT_CHANNEL:-#auto-trading-error}"
export GRAPH_RAG_PHASE5_ALERT_CASE_LIMIT="${GRAPH_RAG_PHASE5_ALERT_CASE_LIMIT:-3}"
export GRAPH_RAG_PHASE5_ALERT_ERROR_MESSAGE_LIMIT="${GRAPH_RAG_PHASE5_ALERT_ERROR_MESSAGE_LIMIT:-2}"
...
KAKAO_SKILL_WEBHOOK_SECRET=${KAKAO_SKILL_WEBHOOK_SECRET}

# Scheduler / Feed / GraphRAG tuning
KR_TOP50_EARNINGS_WATCH_INTERVAL_MINUTES=${KR_TOP50_EARNINGS_WATCH_INTERVAL_MINUTES}
TIER1_EVENT_SYNC_INCLUDE_KR_IR_NEWS=${TIER1_EVENT_SYNC_INCLUDE_KR_IR_NEWS}
KR_TIER1_IR_FEED_URLS=${KR_TIER1_IR_FEED_URLS}
GRAPH_RAG_ROUTER_LLM_TIMEOUT_SEC=${GRAPH_RAG_ROUTER_LLM_TIMEOUT_SEC}
GRAPH_RAG_RECENT_DOC_PRIORITY_COUNT=${GRAPH_RAG_RECENT_DOC_PRIORITY_COUNT}
GRAPH_RAG_RECENT_CITATION_TARGET_COUNT=${GRAPH_RAG_RECENT_CITATION_TARGET_COUNT}
GRAPH_RAG_RECENT_CITATION_MAX_AGE_HOURS=${GRAPH_RAG_RECENT_CITATION_MAX_AGE_HOURS}
GRAPH_RAG_DATA_FRESHNESS_WARN_HOURS=${GRAPH_RAG_DATA_FRESHNESS_WARN_HOURS}
GRAPH_RAG_DATA_FRESHNESS_FAIL_HOURS=${GRAPH_RAG_DATA_FRESHNESS_FAIL_HOURS}
GRAPH_RAG_PHASE5_ALERT_ENABLED=${GRAPH_RAG_PHASE5_ALERT_ENABLED}
GRAPH_RAG_PHASE5_ALERT_ONLY_ON_WARNING=${GRAPH_RAG_PHASE5_ALERT_ONLY_ON_WARNING}
GRAPH_RAG_PHASE5_ALERT_CHANNEL="${GRAPH_RAG_PHASE5_ALERT_CHANNEL}"
GRAPH_RAG_PHASE5_ALERT_CASE_LIMIT=${GRAPH_RAG_PHASE5_ALERT_CASE_LIMIT}
GRAPH_RAG_PHASE5_ALERT_ERROR_MESSAGE_LIMIT=${GRAPH_RAG_PHASE5_ALERT_ERROR_MESSAGE_LIMIT}
...
NEO4J_MACRO_URI=${NEO4J_MACRO_URI}
EOF
