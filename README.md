...
[2] 경제 뉴스 수집 (지난 20일, 특정 국가)
  ↓
[3] 뉴스 LLM 요약 (gemini-3.1-pro)
  ↓
[4] AI 분석 및 전략 결정 (gemini-3.1-pro-preview)
  ↓
[5] 결과 저장
  ↓
END
...
3. **뉴스 LLM 요약**: gemini-3.1-pro로 주요 경제 지표 변화, 경제 흐름, 주요 이벤트 도출 및 요약
...
2. **AI 분석** (매일 08:30) - LangGraph 워크플로우
   - FRED 정량 시그널 계산
   - 지난 20일간 특정 국가 뉴스 수집
   - 뉴스 LLM 요약 (gemini-3.1-pro)
   - 종합 분석 및 포트폴리오 목표 비중 결정 (gemini-3.1-pro-preview)
   - 결과 저장
...
- **노드 3 (summarize_news)**: 뉴스 LLM 요약 (gemini-3.1-pro)
- **노드 4 (analyze)**: AI 분석 및 전략 결정 (gemini-3.1-pro-preview)
