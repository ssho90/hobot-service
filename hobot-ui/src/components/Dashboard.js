...
const Dashboard = () => {
  ...
  useEffect(() => {
    if ((activeTab === 'admin-users' || activeTab === 'admin-logs' || activeTab === 'admin-llm-monitoring' || activeTab === 'admin-sector-management' || activeTab === 'admin-portfolio-management') && !isSystemAdmin()) {
      setActiveTab('news');
    }
  }, [activeTab, isSystemAdmin]);
